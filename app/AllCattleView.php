...
class AllCattleView extends Model
{
    use Sortable;

    protected $table = 'all_cattle_view';
	public $timestamps = false;
    public $sortable = ['kind', 'tag', 'breed_name', 'control_tag', 'empadre_date', 'birth', 'purchase_date', 'sale_date', 'current_weight', 'age_in_months', 'pregnancy_status', 'months_since_last_birth', 'gender'];
