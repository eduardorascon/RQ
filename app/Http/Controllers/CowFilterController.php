    ...
    public function get_data(Request $request)
    {
        ...
        else
        {
            ...
            if($request->has('control_tag'))
                $cows->where('cows_view.control_tag', '=', $request->control_tag)->orWhere('cows_view.control_tag', 'like', '%' . $request->control_tag . '%');
            ...
            if($request->has('cattle_empadre_since') && $request->has('cattle_empadre_until'))
            {
                ...
                $cows->whereBetween('cows_view.empadre_date', array($empadre_since, $empadre_until))->
                    orWhereBetween('cows_view.empadre_date', array($empadre_until, $empadre_since));
            }
