...
select b.id, b.sale_id, c.tag, c.purchase_date, c.birth, c.is_alive, c.gender, br.name as breed_name, o.name as owner_name, p.name as paddock_name,
...
select co.id, co.sale_id, c.tag, c.purchase_date, c.birth, c.is_alive, c.gender, br.name as breed_name, o.name as owner_name, p.name as paddock_name,
(select weight from weight_logs where cattle_id = c.id order by date desc limit 1) as peso
from cows co
