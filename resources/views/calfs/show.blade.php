			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<div class="form-horizontal">
						...
						<div class="col-sm-10">
							<input type="text" name="cattle_birth_date" class="form-control" readonly="readonly" value="{{ $calf->cattle->birth }}" />
						</div>
						</div>
						...
						<div class="col-sm-10">
							<input type="text" name="cattle_purchase_date" class="form-control" readonly="readonly" value="{{ $calf->cattle->purchase_date }}" />
						</div>
						</div>
