	...
	<div class="row">
		<div class="col-md-offset-1 col-md-10">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<div class="form-horizontal">
						...
						<div class="col-sm-10">
							<input type="date" name="cattle_birth_date" class="form-control" readonly="readonly" value="{{ $calf->cattle->birth }}" />
						</div>
						</div>
						...
						<div class="col-sm-10">
							<input type="date" name="cattle_purchase_date" class="form-control" readonly="readonly" value="{{ $calf->cattle->purchase_date }}" />
						</div>
						</div>
			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<form class="form-inline" action="{{ route('log_weight', $calf->id) }}" method="post">
						{{ csrf_field() }}
						<div class="row">
							<div class="col-sm-10">
