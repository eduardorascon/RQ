				...
				<div class="panel-body">
					<form class="form-horizontal" action="{{ route('cows.update', $cow->id) }}" method="post">
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" name="control_tag" class="form-control" placeholder="Etiqueta" value="{{ $cow->cattle->control_tag }}">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" name="empadre_date" class="form-control input-date" placeholder="dd/mm/aaaa" value="{{ $cow->cattle->empadre_date }}" >
							</div>
						</div>
