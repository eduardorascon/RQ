				...
				<div class="panel-body">
					<div class="form-horizontal">
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" name="control_tag" class="form-control" readonly="readonly" placeholder="Etiqueta" value="{{ $cow->cattle->control_tag }}">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" name="empadre_date" class="form-control input-date" readonly="readonly" placeholder="dd/mm/aaaa" value="{{ $cow->cattle->empadre_date }}" >
							</div>
						</div>
					...
					<div class="table-responsive">
						...
						@foreach($offspring as $o)
							<tr>
								...
								<td>{{ $o->age_in_months }} meses</td>
								<td>
									<form class="" action="{{ route('calves.destroy', $o->id) }}" method="post">
	                    				...
	                    				<a class="btn btn-warning btn-sm" data-container="body" data-toggle="tooltip" data-placement="top" title="Editar información del registro" href="{{ route('calves.edit', $o->id) }}">
