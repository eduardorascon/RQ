			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<form class="form-horizontal" action="{{ route('cows.update', $cow->id) }}" method="post">
						...
						<div class="col-sm-10">
							<input type="date" name="cattle_birth_date" class="form-control" readonly="readonly" value="{{ $cow->cattle->birth }}" />
						</div>
						</div>
						...
						<div class="col-sm-10">
							<input type="date" name="cattle_purchase_date" class="form-control" readonly="readonly" value="{{ $cow->cattle->purchase_date }}" />
						</div>
						</div>
