        ...
        <div class="col-md-offset-1 col-md-10">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <strong>DUEÑOS, Cambios en registro</strong>
                </div>
                @if (count($errors) > 0)
                ...
                <div class="panel-body">
                    <form class="" action="{{ route('owners.update', $owner->id) }}" method="post">
                        ...
                        <div class="col-sm-offset-3 col-sm-3">
                            <a class="btn btn-danger btn-sm pull-right" href="{{ route('owners.index') }}">
